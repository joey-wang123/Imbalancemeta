...
class Quickdraw(CombinationMetaDataset):
    ...
    def __init__(self, root, num_classes_per_task=None, meta_train=False,
        ...
        dataset = QuickdrawClassDataset(root, meta_train=meta_train, meta_val=meta_val,
...
class QuickdrawClassDataset(ClassDataset):
    ...
    def __init__(self, root, meta_train=False, meta_val=False, meta_test=False,
        ...
        # print('quickdraw self.meta_split', self.meta_split)
    def __getitem__(self, index):
        ...
        return QuickdrawDataset(index, data, label, transform=transform,
